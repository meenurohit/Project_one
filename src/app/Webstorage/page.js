...
const WebStorage = () => {
  ...
  console.log("No Web Storage support.");
        ...
        <div className="mb-4">
          <button className="px-4 py-2 bg-green-500 text-white rounded-md mr-2">Store Data</button>
          <button  className="px-4 py-2 bg-red-500 text-white rounded-md">Remove Data</button>
        </div>
        <p className="font-semibold">Stored Value: <span className="text-blue-600"></span></p>

        <h3 className="text-lg font-semibold mt-6 mb-2">Interactive sessionStorage Example</h3>
        <div className="mb-4">
          <button  className="px-4 py-2 bg-blue-500 text-white rounded-md">Click to Increment</button>
        </div>
        <p className="font-semibold">Click Count (Session): <span className="text-blue-600"></span></p>
